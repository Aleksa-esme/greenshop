const search = {
    ...
    template: `
            <div class="search">
                <form class="search_form" action="#" @submit.prevent="$parent.$refs.catalog.filter(searchLine)">
                    <input v-model="searchLine" class="search_input" type="text" placeholder="Find your plants">
                    <button class="svg_button search_button" @submit.prevent="$parent.$refs.catalog.filter(searchLine)">
